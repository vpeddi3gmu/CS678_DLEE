...
if __name__ == "__main__":
    ...
    parser.add_argument('--result-file', type=str,
                        default='checkpoints/gen-KAIROS-pointer-pred/predictions.jsonl')
    parser.add_argument('--test-file', type=str,
                        default='data/kairos/test.jsonl')
    ...
    with open(args.test_file, 'r') as f:
        for line in f:
            ...
            # word index to start, end char index (end is not inclusive)
            word2char = {}
            ptr = 0
            ...
            for eidx, e in enumerate(doc['event_mentions']):
                ...
                if args.gold:
                    ...
                    for arg in e['arguments']:
                        ...
                        # get entity span
                        matched_ent = [
                            entity for entity in doc['entity_mentions'] if entity['id'] == ent_id][0]
                    ...
                    predicted_args = extract_args_from_template(
                        filled_template, template, ontology_dict, evt_type)
                    # get trigger
